...
## Dataset
Due to licensing restrictions, the PACMAN dataset is not publicly available. Therefore running this code in full (re-training, evaluation etc) is not possible. The uploaded code provides a guide to those who want to adapt our work for their registration task and dataset. 
